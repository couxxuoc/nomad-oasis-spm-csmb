![docker image](https://github.com/couxxuoc/nomad-oasis-spm-csmb/actions/workflows/docker-publish.yml/badge.svg)


# couxxuoc's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of couxxuoc.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/couxxuoc/nomad-oasis-spm-csmb.git
    cd nomad-oasis-spm-csmb
    ```

    or

    ```sh
    curl-L -o nomad-oasis-spm-csmb.zip "https://github.com/couxxuoc/nomad-oasis-spm-csmb/archive/main.zip"
    unzip nomad-oasis-spm-csmb.zip
    cd nomad-oasis-spm-csmb
    ```
...
your `docker-compose.yaml` with `ghcr.io/couxxuoc/nomad-oasis-spm-csmb:main` for the services
...
```
docker pull ghcr.io/couxxuoc/nomad-oasis-spm-csmb/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/couxxuoc/nomad-oasis-spm-csmb/manifests/main": unauthorized`
